 ...
 */
public class RecombineDiseaseGroupsCombonent extends VerticalLayout implements LayoutEvents.LayoutClickListener {
    ...
    private HorizontalLayout initDiseaseNamesUpdateContainer(DiseaseCategoryObject diseaseCategory,int width) {
        ...
        for (String diseaseGroupName : diseaseCategory.getDiseaseSubGroups()) {    
...
//            diseaseNamesUpdateContainer.setComponentAlignment(label, Alignment.MIDDLE_CENTER);
...
//            diseaseNamesUpdateContainer.setComponentAlignment(list, Alignment.MIDDLE_CENTER);
            ...
            spacer2.setStyleName("whitelayout");//"lightgraylayout");
...
//        widthCalc-=26;
    ...
    private ComboBox generateLabelList(DiseaseCategoryObject diseaseCategory) {
