...
import no.uib.probe.csf.pr.touch.view.core.InformationField;
...
//    private final Set<VerticalLayout> ptmsLayoutMap = new HashSet<VerticalLayout>();
     ...
     * @param dsID
     */
    public PeptidesInformationOverviewLayout(String sequence, Set<QuantPeptide> quantPepSet, int width, final boolean minMode, LayoutEvents.LayoutClickListener listener, final int dsID,boolean smallScreen,String proteinName) {
...
//        System.out.println("at char width is " + charW);
        double updatedWidth = 0;
        Map<Integer, Integer> extraSizeLeveMap = new HashMap<Integer, Integer>();
...
//            updatedWidth = updatedWidth+( ((peptideSequence.length() * charW) - peptideLayoutWidth));
